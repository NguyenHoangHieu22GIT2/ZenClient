...
export const ActionsForFriendsPageGeneralComponent= (props: props) => {
  ...
  function notInterested(userId: UserId, onSetUsers: React.Dispatch<React.SetStateAction<ztUserMinimalData[]>>) {
  ...
  return (
    <>
      <Button
        ...
        onClick={notInterested.bind(null, props.userId, props.args.onSetUsers)}
        variant={"ghost"}
      >
