...
import { zChangeNormalInformationDto, ztChangeNormalInformationDto } from "@/dtos/user/change-normal-information.dto";
...
export default function Information() {
  ...
  const { mutate, isLoading, error } = useMutation({
    ...
    mutationFn: async (data: ztChangeNormalInformationDto) => {
      ...
      return api.patch<ztChangeNormalInformationDto>("users/change-information", parsedData, { withCredentials: true }).then((result) => {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea {...field} placeholder="Write what you want people to know about you" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
